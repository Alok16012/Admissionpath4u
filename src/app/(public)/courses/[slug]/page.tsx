      ...
      <div className="bg-gray-50 border-b py-3">
        <div className="container mx-auto px-6">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            <Link href="/" className="hover:text-[#27465B]">Home</Link>
            <ChevronRight className="w-3 h-3" />
            <Link href="/colleges" className="hover:text-[#27465B]">Colleges</Link>
            <ChevronRight className="w-3 h-3" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Top <span className="text-[#BDA25F]">{course.name}</span> Colleges in India
            </h1>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
            <div className="py-5 px-4 flex items-center gap-3">
              <Clock className="w-5 h-5 text-[#27465B] flex-shrink-0" />
              <div>
            ...
            <div className="py-5 px-4 flex items-center gap-3">
              <BookOpen className="w-5 h-5 text-[#27465B] flex-shrink-0" />
              <div>
            ...
            <div className="py-5 px-4 flex items-center gap-3">
              <Users className="w-5 h-5 text-[#27465B] flex-shrink-0" />
              <div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="w-full lg:w-72 flex-shrink-0">
              <div className="sticky top-24 space-y-4">
                  ...
                  <ul className="space-y-2">
                    {course.highlights.map((h, i) => (
                      <li key={i} className="flex items-start gap-2 text-xs text-gray-700">
                        <CheckCircle className="w-3.5 h-3.5 text-[#27465B] flex-shrink-0 mt-0.5" />
                        {h}
                      </li>
                    ))}
                  </ul>
                ...
                {/* CTA */}
                <div className="bg-gradient-to-br from-[#27465B] to-[#1b3242] rounded-2xl p-5 text-white text-center">
                  ...
                  <Button asChild size="sm" className="bg-[#BDA25F] hover:bg-[#BDA25F]/90 text-black font-bold w-full border-none">
            ...
            <main className="flex-1">
              ...
              {colleges.length > 0 ? (
                ...
                <div className="py-20 text-center border rounded-2xl bg-white">
                  ...
                  <Button asChild className="mt-4 bg-[#27465B] hover:bg-[#1b3242] text-white">
            ...
            {Object.values(COURSE_CONFIG)
              ...
              .map((c) => (
                <Link
                  key={c.slug}
                  href={`/courses/${c.slug}`}
                  className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 hover:bg-[#27465B] hover:text-white text-gray-700 rounded-full text-sm font-medium border border-gray-200 hover:border-[#27465B] transition-all"
                >
                  {c.name}
                </Link>
              ))}
