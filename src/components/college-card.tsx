  ...
  return (
    <Card className="overflow-hidden flex flex-col h-full hover:shadow-lg transition-shadow py-0! gap-0!">
      <div className="h-48 w-full bg-gray-200 relative shrink-0">
        ...
        {isTopPlacement && (
          <div className="absolute top-3 left-3">
            <span className="inline-flex items-center gap-1 bg-[#FFD700] text-[#800000] text-xs font-bold px-2.5 py-1 rounded-full shadow">
      ...
      <CardFooter className="p-4 pt-0">
        <Button
          asChild
          className="w-full bg-[#800000] hover:bg-[#900000] text-white"
        >
